        ...
        if typename[0] in types_mapping_to_preset_data.keys():
            ...
            for i in filtered_listoffieldmappings_list:
                if i[0] in temp_preset.keys():
                    ...
                    filtered_listoffieldmappings_list[index][4] = temp_preset[i[0]
                                                                              ]["Recommended"]
                    filtered_listoffieldmappings_list[index][5] = temp_preset[i[0]
                                                                              ]["UI Visibility"]
